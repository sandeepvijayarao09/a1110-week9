...
def assess_risk(
    ...
    if new_imports:
        score -= 10 * len(new_imports)
        reasons.append(f"Fix introduced {len(new_imports)} new import(s); verify they are intentional.")
    ...
    # Auto-fix policy
    # ----------------------------
    # Require score >= 80 (stricter than just "low" level which starts at 75)
    # to reduce the chance of blindly applying risky AI-generated fixes.
    should_autofix = score >= 80
